...
namespace Data.Migrations
{
    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ServiceProfessionalAppointments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceProfessionalAppointments", x => new { x.ServiceId, x.ProfessionalId, x.AppointmentId });
                    table.ForeignKey(
                        name: "FK_ServiceProfessionalAppointments_Appointments_AppointmentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceProfessionalAppointments_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Professionals_ApplicationUserId",
                table: "Professionals",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProfessionalAppointments_AppointmentId",
                table: "ServiceProfessionalAppointments",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProfessionalAppointments_ProfessionalId",
                table: "ServiceProfessionalAppointments",
